...
class Country extends Resource
{
     ...
     * @var string
     */
    public static $model = \App\General\Country::class;
    ...
    public function fields(Request $request)
    {
        return [
            ...
            // BelongsTo::make('Currency', 'currency', 'App\Nova\Currency')->rules('required'),

            Image::make(__('icon'), 'icon')
                ->disk('Root')
                ->store(function (Request $request, $model) {
                    $filename = Str::random(50) . '.' . $request->icon->getClientOriginalExtension();
                    $request->icon->move(public_path('/uploads/countries/'), $filename);
                    return [
                        'icon' => '/uploads/countries/' . $filename,
                    ];
                })
                ->prunable()
