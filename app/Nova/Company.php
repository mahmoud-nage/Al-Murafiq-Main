...
class Company extends Resource
{
    ...
    public function fields(Request $request)
    {
        return [
            ...
            BelongsToMany::make(__('Subscriptions'),'Subscriptions', Subscription::class)->fields(function(){
                return [
                    Date::make('from')->rules('required','after_or_equal:today')->default(date(today())),
                ];
            }),
