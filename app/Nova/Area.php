...
class Area extends Resource
{
     ...
     * @var string
     */
    public static $model = \App\General\Area::class;
    ...
    {
        return __('areas'); // TODO: Change the autogenerated stub
    }
    ...
    public function fields(Request $request)
    {
        return [
            ...
            BelongsTo::make(__('city'), 'city', 'App\Nova\City')->rules('required'),

            Boolean::make(__('active'),'active')->trueValue(1)->falseValue(0)->sortable()->default(1),

            HasMany::make(_('zones'),'zones', Zone::class),
        ];
    }
