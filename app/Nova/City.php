...
class City extends Resource
{
     ...
     * @var string
     */
    public static $model = \App\General\City::class;
    ...
    {
        return __('cities'); // TODO: Change the autogenerated stub
    }
    ...
    public function fields(Request $request)
    {
        return [
            ...
            BelongsTo::make(__('country'), 'country', 'App\Nova\Country')->rules('required'),
