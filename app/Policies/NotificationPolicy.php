...
class NotificationPolicy
{
    ...
    public static $key = 'Notification';

    public static function attachAnyUser(User $user, Notification $notification)
    {
        return false;
    }
    /**
    ...
    {
        return $user->can('view own Notification');
        //
    }
    ...
    {
        return $user->can('manage own Notification');
        //
    }
